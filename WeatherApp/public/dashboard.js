...
colors = ['#FF5733', '#1E90FF', '#32CD32', '#FFD700', '#8A2BE2', '#FF4500', '#00CED1', '#FF69B4', '#00FF00', '#FF6347', '#4169E1', '#FF7F50', '#7FFF00', '#9932CC', '#00FFFF', '#FF8C00', '#20B2AA', '#FF1493', '#00BFFF', '#2E8B57'];


datasets = [{ label: 'Küche',      data: kitchenData,    borderColor: '#FF5733' },
